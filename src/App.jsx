    ...
    <>
      <nav>
        <a href="#" className="nav-logo">
          <span className="logo-placeholder-small" aria-hidden="true">
            GC
          </span>
          Garden Clock
        </a>
      ...
      <section className="hero">
        <div className="hero-content">
          <div className="logo-placeholder-large" role="img" aria-label="Garden Clock logo placeholder">
            Garden Clock logo
          </div>
        ...
        <div className="video-section">
          <div className="video-frame">
            <div className="video-placeholder">
              ...
              <small>Drop final product video here</small>
            </div>
          </div>
      ...
      <footer>
        <span className="footer-logo">
          <span className="logo-placeholder-footer" aria-hidden="true">
            GC
          </span>
          Garden Clock
        </span>
